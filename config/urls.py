...
def api_root(request):
    return JsonResponse({
        ...
        'auth': {
            ...
            'password_reset_confirm': 'POST /api/v1/auth/password-reset/confirm/',
...
html_routes = [
    ...
    path('app/forgot-password/',              TemplateView.as_view(template_name='app/public/forgot-password.html'),   name='forgot-password'),
    path('app/reset-password/',               TemplateView.as_view(template_name='app/public/reset-password.html'),    name='reset-password'),
    ...
    path('app/requests/',                     TemplateView.as_view(template_name='app/teacher/requests.html'),         name='teacher-requests'),
